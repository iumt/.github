Willkommen bei der **Internet Unicode Migration Taskforce (IUMT)** – einer internationalen Initiative zur vollständigen, koordinativen Umstellung des Internets auf native Unicode-Unterstützung, ohne Punycode-Zwischenlösungen.
...
2. Diskussion starten: [issues/](./issues) oder [forum](https://forum.iumt.org)
3. Beispiel-DNS-Konfigurationen mit Unicode testen (in `examples/`)
4. Manifest unterzeichnen: [`MANIFEST.md`](./MANIFEST.md)
